...
export const translations: Record<TranslationKey, Record<Locale, string>> = {
  ...
  'home.agents.gateway': { en: 'Powered through the SHANAN AI Gateway', ar: 'مدعوم عبر بوابة شانان للذكاء الاصطناعي' },
  'home.agents.readiness': { en: 'AI-READY · ACTIVATED PER CAPABILITY AND AVAILABILITY', ar: 'جاهز للذكاء الاصطناعي · يُفعَّل حسب القدرة والتوافر' },
